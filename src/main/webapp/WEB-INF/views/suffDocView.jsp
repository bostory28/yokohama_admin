...
<script type="text/javascript">
      ...
      function moveCategory(category) {
           ...
           document.categoryForm.viewName.value="suffDocView";
           document.categoryForm.submit();
      }
      
      //学生の願書OZ-FORM
      function goAppForm(rid, sort, number) {
           switch(sort) {
           ...
           var height = screen.height;
            window.open("http://192.168.1.51:9999/kissco/oz/samplekannryou.html?sort="+ sort + "&rid="+rid + "&number=" + number, "願書", "width="+width*2/3+", height="+height+", location=no, toolbar=no, menubar=no, scrollbars=no, resizable=yes");
      ...
      <div class="col-xs-8 col-xs-offset-2">
           ...
           <div class="container_tmp">
                      ...
                      <table class="table table-hover table-bordered">
                            ...
                            <c:if test="${appList != null}">
                                  <c:forEach var="appList" items="${appList}" varStatus="status">
                                       <tr class="tr">
                                             <td><a href="javascript:goAppForm('${appList.rid }', '${appList.name }', '${appList.number }')">${appList.number }</a>
                                             <td>完了
                                             <td>${appList.name }
                 ...
                 <form name="arrayField" method="post">
                      ...
                      <input type="hidden" name="viewName" value="suffDocView">
